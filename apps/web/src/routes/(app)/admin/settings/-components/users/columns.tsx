  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const [openDialog, setOpenDialog] = useState<
        "ban" | "unban" | "delete" | "setUserRole" | "setUserPassword" | null
      >(null);
      ...
      const generateRandomPassword = () => {
        const randomLength =
          Math.floor(
            Math.random() * (MAX_PASSWORD_LENGTH - MIN_PASSWORD_LENGTH)
          ) + MIN_PASSWORD_LENGTH;
      ...
      const banForm = useForm({
        ...
        onSubmit: ({ value }) => {
          ...
          handleBan(
            value.banReason,
            daysUntilBanExpires
              ? daysUntilBanExpires * SECONDS_IN_DAY
              : undefined
          );
        },
      });
        ...
        <>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onSelect={() => setOpenDialog("setUserRole")}>
                Change user role
              </DropdownMenuItem>
              <DropdownMenuItem
                onSelect={() => setOpenDialog("setUserPassword")}
              >
